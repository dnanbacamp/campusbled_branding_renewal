...
interface CurveDividerProps {
  ...
  direction?: "up" | "down";
  fill?: string;
  /** background of the box behind the curve (the area the SVG leaves unfilled) */
  background?: string;
}
...
export default function CurveDivider({ direction = "up", fill, background }: CurveDividerProps) {
  return (
    <div className="curve" aria-hidden="true" style={background ? { background } : undefined}>
